            ...
            <div className='container'>
                <div className='col d-flex flex-column mt-3'>
                    ...
                    <div className='d-flex flex-row mt-3 align-items-center mb-5'>
                        ...
                        <a href='https://instagram.com/joshuaddhartha?igshid=ZDdkNTZiNTM=' rel='noopener' target={'_blank'}>
                        ...
                        <a href='https://twitter.com/joshuaddhartha?t=KeqOPq7Ii3yUGQuQSdREzw&s=08' rel='noopener' target={'_blank'}>
                            <div style={{ width: 30 }}>
